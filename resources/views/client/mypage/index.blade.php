                ...
                <div class="wrapItemQuestion">
                    <div class="itemQuestion">
                        ...
                        {{-- 0 m --}}
                            ...
                            @else
                                ...
                                @else
                                <a href="" class="wrapLinkQuestion hide-button" style="background: #8bbde2" id="oneMonths">
                                    Answered
                                </a>
                                @endif
                            @endif
                    ...
                    <div class="itemQuestion">
                        <div class="titleQuestion">
                            ...
                            @if (empty(Auth::user()->join_event))
                                <a href="" class="wrapLinkQuestion hide-button" id="twoMonths">
                                    Before release
                                </a>
                            @else
                                ...
                                @if ($currentTime > $threeMonth)
                                    @if (Auth::user()->status_view == 1)
                                        <a href="" class="wrapLinkQuestion" id="twoMonths">
                                            To answer
                                        </a>
                                    @endif
                                    @if (Auth::user()->status_view == 2)
                                        <a href="" class="wrapLinkQuestion hide-button" style="background: #8bbde2" id="twoMonths">
                                            To answer
                                        </a>
                                    @endif
                                    @if (Auth::user()->status_view > 2)
